        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {steps.map(({ icon: Icon, step, title, description }, i) => (
            ...
            >
              ...
              {i < steps.length - 1 && (
                <div className="hidden lg:block absolute top-8 left-1/2 w-full h-px bg-gradient-to-r from-accent-500/30 to-transparent z-0" />
              )}

              <div className="relative z-10">
                {/* Step number badge */}
                <div className="relative inline-flex mb-5">
                  <div className="w-16 h-16 bg-navy-800 border-2 border-accent-500/40 group-hover:border-accent-500 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:shadow-lg group-hover:shadow-accent-500/20">
